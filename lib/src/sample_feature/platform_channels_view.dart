...
class _PlatformChannelsViewState extends State<PlatformChannelsView> {
  ...
  Future<void> _getChannelPerf() async {
    ...
    final double ms12 = (t2[0] - t1[0]) * 1000.0 + (t2[1] - t1[1]) / 1000000.0;
    ...
    final double ms34 = (t4[0] - t3[0]) * 1000.0 + (t4[1] - t3[1]) / 1000000.0;
